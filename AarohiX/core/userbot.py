...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("rajabhaiya2u")
                await self.two.join_chat("anikahindishayri")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("rajabhaiya2u")
                await self.three.join_chat("anikahindishayri")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("rajabhaiya2u")
                await self.four.join_chat("anikahindishayri")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("rajabhaiya2u")
                await self.five.join_chat("anikahindishayri")
            except:
                pass
            assistants.append(5)
